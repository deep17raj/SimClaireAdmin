...
import {
    ...
    Globe, AlertCircle, Loader2, Mail, Phone, Calendar, CheckCircle2, XCircle, Download
} from "lucide-react";
...
export default function AdminPartnerProfileView() {
    ...
    const handleExportCSV = async () => {
        ...
        try {
            ...
            const queryParams = {};
            if (exportFromDate) queryParams.from_date = exportFromDate;
            if (exportToDate) queryParams.to_date = exportToDate;

            // Fetch the blob response from the export API
            const response = await axios.get(
                `${process.env.NEXT_PUBLIC_API_URL}/admin/partners/${partnerAccessId}/export`,
                {
            ...
            let fileName = `partner-${partnerAccessId}-sales-export.csv`;
    ...
    return (
        <div className="min-h-screen bg-[#fafafa] p-4 md:p-8 font-sans pb-20">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3 mb-10 py-4 bg-white p-2 rounded-xl border border-slate-200 shadow-sm w-full  lg:w-110 h-max shrink-0">
